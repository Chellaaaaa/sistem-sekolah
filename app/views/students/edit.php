    ...
    <!-- Header Start -->
     <header class="bg-blue-900 text-white">
        <div class="flex items-center justify-between container mx-auto p-4">
            ...
            <a class="py-2 px-4 bg-white text-blue-900 rounded-lg" href="/students/create">+ Tambah Siswa</a>
        </div>
     </header>
    <!-- Header End-->
             ...
             <div class="bg-white rounded-lg shadow">
               <form action="" class="p-4 grid grid-cols-2 gap-4">
                ...
                <div class="space-y-2">
                    ...
                    <input class="px-4 py-2 border rounded-lg w-full" type="text" id="phone_number" name="phone_number" placeholder="Masukkan No Telepon">
                </div>

                <div class="flex justify-end gap-4 col-span-2">
                    <a href="/students" class="px-4 py-2 rounded-lg bg-gray-100">Kembali</a>
                    <button class="px-4 py-2 rounded-lg bg-blue-800 text-white" type="submit">Simpan</button>
                </div>
               </form>
             </div>
            <!-- Card Content End -->
